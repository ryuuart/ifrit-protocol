...
inline constexpr Node kNodes[] = {
    ...
    {227.70f, 335.93f, 3, 0, Kind::Mastery, State::CanAllocate,
     "Ember Mastery"},
    ...
    {699.83f, 431.97f, 5, 0, Kind::Mastery, State::Unallocated,
     "Ember Mastery"},
    ...
    {543.50f, 503.76f, 7, 2, Kind::Minor, State::Unallocated,
     "Elemental Damage"},
    {434.64f, 525.42f, 7, 2, Kind::Minor, State::Unallocated, "Cast Speed"},
    {491.23f, 525.42f, 7, 0, Kind::Mastery, State::Unallocated,
     "Ember Mastery"},
...
inline constexpr Edge kEdges[] = {
    {0, 3, false, 0xFF},   {0, 4, true, 0},       {1, 8, true, 0},
    {2, 7, true, 1},       {2, 6, false, 0xFF},   {2, 5, true, 1},
    {4, 23, false, 0xFF},  {4, 8, true, 0},       {5, 9, true, 1},
    {7, 9, true, 1},       {9, 23, false, 0xFF},  {10, 14, true, 2},
    {10, 11, true, 2},     {11, 16, true, 2},     {12, 21, false, 0xFF},
    {12, 17, true, 3},     {12, 13, true, 3},     {13, 18, true, 3},
    {14, 19, true, 2},     {14, 23, false, 0xFF}, {15, 16, false, 0xFF},
    {16, 20, true, 2},     {17, 24, true, 3},     {18, 22, true, 3},
    {19, 20, true, 2},     {21, 30, false, 0xFF}, {22, 25, true, 3},
    {22, 23, false, 0xFF}, {23, 27, false, 0xFF}, {23, 33, false, 0xFF},
    {23, 26, false, 0xFF}, {24, 30, true, 3},     {25, 31, true, 3},
    {26, 32, true, 5},     {28, 29, false, 0xFF}, {29, 32, true, 5},
    {30, 31, true, 3},     {33, 35, true, 7},     {33, 34, true, 7},
    {34, 37, true, 7},     {35, 38, true, 7},     {36, 38, false, 0xFF},
    {37, 38, true, 7},
};
...
inline constexpr Detail kDetails[] = {
    {"EMBERWARDEN",
     "KEYSTONE",
     {"Fire damage you take is dealt over 4 seconds", "You cannot be Ignited",
      nullptr},
     "The first flame asked only to be carried."},
    {"HOLLOW COVENANT",
     "KEYSTONE",
     {"Life recovery applies to Energy Shield instead",
      "Maximum Life is halved", nullptr},
     "Trade the vessel; keep the flame."},
    {"STILLPOINT",
     "KEYSTONE",
     {"Skills cost no Mana while stationary",
      "You cannot regenerate Mana while moving", nullptr},
     "The world turns. You need not."},
    {"Kindled Reserve",
     "NOTABLE",
     {"18% increased Fire Damage", "+12 to maximum Life", nullptr},
     nullptr},
    {"Cinderpath",
     "NOTABLE",
     {"20% increased Damage over Time", "10% increased Area of Effect",
      nullptr},
     nullptr},
    {"Ashen Discipline",
     "NOTABLE",
     {"+16% to Fire Resistance", "6% increased maximum Life", nullptr},
     nullptr},
    {"Wickwright",
     "NOTABLE",
     {"25% increased Ignite Duration", "12% increased Burning Damage", nullptr},
     nullptr},
    {"Tinderheart",
     "NOTABLE",
     {"+20 to maximum Life", "8% increased Attack Speed while on Low Life",
      nullptr},
     nullptr},
    {"Long Watch",
     "NOTABLE",
     {"+8% to all Elemental Resistances", "15% increased Stun Threshold",
      nullptr},
     nullptr},
    {"Sootbound",
     "NOTABLE",
     {"30% increased Armour", "5% additional Physical Damage Reduction",
      nullptr},
     nullptr},
    {"Emberglass",
     "NOTABLE",
     {"+40 to maximum Energy Shield",
      "10% increased Energy Shield Recharge Rate", nullptr},
     nullptr},
};
inline constexpr int kDetailCount =
