/** @file
 * organic — the scene where nothing is a rectangle: seeded blobs, a
 * rounded star ringed by stamped ornament, radial runes on a contour,
 * a per-edge plaque, routed connectors and a live hit probe.
 */
...
struct Organic final : sketch::Sketch {
