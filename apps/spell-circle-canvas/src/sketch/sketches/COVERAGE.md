...
| Font metrics and glyph paint | [optical_kerning](optical_kerning.cpp), [axis_ripple](axis_ripple.cpp), [text_paints](text_paints.cpp), [paragraph_paints](paragraph_paints/paragraph_paints.cpp), [paint_anchors](paint_anchors.cpp) | Spacing, variable axes and paints resolved against text geometry, and the box a paint is stretched over. |
