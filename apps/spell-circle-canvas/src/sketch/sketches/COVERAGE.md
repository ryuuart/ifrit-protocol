...
| The cascade, the theme and environment values | [cascade](cascade.cpp), [env_faces](env_faces.cpp), [env_lanes](env_lanes.cpp) | The font, the ink and the custom properties down the tree; classes; a lexical theme beside them, with nested overrides and the point at which values become component properties. |
...
| Font metrics and glyph paint | [optical_kerning](optical_kerning.cpp), [axis_ripple](axis_ripple.cpp), [text_paints](text_paints.cpp), [paragraph_paints](paragraph_paints/paragraph_paints.cpp), [paint_anchors](paint_anchors.cpp), [ink_units](ink_units.cpp) | Spacing, variable axes and paints resolved against text geometry, the box a paint is stretched over, and a paint restarted on each unit of a passage. |
...
| Material recipes and shader backends | [stock_materials](stock_materials.cpp), [material_slots](material_slots.cpp), [slang_portable](slang_portable.cpp) | Stock recipe registration, live child materials and portable shader execution. |
...
| Tabular data, scales and reported checks | [data_scales](data_scales.cpp), [nightingale_coxcomb](nightingale_coxcomb/nightingale_coxcomb.cpp), [dunhuang_star_chart](dunhuang_star_chart/dunhuang_star_chart.cpp), [minard_1869](minard_1869/minard_1869.cpp) | Decoding tables, domain mapping and calculations displayed beside the drawing. |
