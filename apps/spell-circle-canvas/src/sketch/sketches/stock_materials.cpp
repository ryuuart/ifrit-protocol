        ...
        stack()
            ...
            .child(
                box()
                    ...
                    .gap(12)
                    .child(
                        swatch("Material::radialUnit",
                               Material::radialUnit({0.5f, 0.5f}, 1.0f, ramp)))
                    .child(swatch(
                        "sdf::circle",
                        sdf::material(sdf::circle(),
                                      {.fill = {0.20f, 0.55f, 0.95f, 1},
                                       .borderWidth = 3,
                                       .borderColor = {1, 1, 1, 0.9f},
                                       .glowRadius = 10,
                                       .glowColor = {0.4f, 0.7f, 1, 0.6f}})))
                    .child(swatch(
                        "sdf::roundBox",
                        sdf::material(sdf::roundBox(14),
                                      {.fill = {0.95f, 0.35f, 0.25f, 1},
                                       .borderWidth = 2,
                                       .borderColor = {1, 0.9f, 0.7f, 0.9f}})))
                    .child(swatch(
                        "sdf::star",
                        sdf::material(sdf::star(6, 2.6f),
                                      {.fill = {0.95f, 0.80f, 0.30f, 1}}))))
            .child(box()
                       .left(24)
                       .top(316)
                       .right(24)
                       ...
                       .gap(12)
                       .child(swatch(
                           "blend(grain over ramp)",
                           Material::blend(
                               {{Material::linearUnit({0, 0}, {0, 1}, ramp),
                                 SkBlendMode::kSrc},
                                {patterns::grain(0.5f, 3, 9.0f),
                                 SkBlendMode::kOverlay}})))
                       .child(swatch(
                           "blend(sdf over grain)",
                           Material::blend(
