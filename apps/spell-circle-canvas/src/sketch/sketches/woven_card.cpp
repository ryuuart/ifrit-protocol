...
struct Card {
  /** The host's fonts, lent at setup: shaping caches warm once for the
   *  process, and a study measures the picture rather than the font
   *  manager. */
...
SIGIL_SKETCH(
    WovenCard, "Set",
    "A live 2D scene as a texture on a swept band \xe2\x80\x94 a compose "
    "tree reconciled and painted into an image, repeating along a "
    "ribbon")
