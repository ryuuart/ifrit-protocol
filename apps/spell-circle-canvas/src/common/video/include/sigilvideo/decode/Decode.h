...
class Video {
 public:
   ...
   *  the probed duration; a non-looping draw clamps to the final frame and
   *  to the first. A clip whose duration the container does not state is
   *  drawn at the time it was given, whichever way. */
