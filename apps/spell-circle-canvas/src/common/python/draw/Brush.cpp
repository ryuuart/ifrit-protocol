...
py::class_<T> record(py::module_& module, const char* name) {
  return bindRecord<T>(module, name, "Unknown brush property: ");
}
...
void bindBrush(py::module_& root) {
  ...
  tool.def_property(
      ...
      [](brush::Tool& tool, py::handle value) {
        ...
        const int count = py::module_::import("sigil._callbacks")
  ...
  py::class_<brush::Plot>(module, "Plot")
      ...
      .def(
          ...
          py::arg("origin") = py::make_tuple(0, 0), py::arg("spacing") = 1.0f,
