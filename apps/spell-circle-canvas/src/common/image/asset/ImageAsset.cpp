/** @file
 * The Skia-codec path: PNG, JPEG, WebP, GIF and AVIF sniffed from the
 * bytes, stills and animations decoded into premultiplied frames, and
 * the asset's playback over them.
 */
