/** @file
 * The Skia-codec decode of every still and animated format, frame
 * compositing, timeline playback, and drawing onto a canvas. Bytes reach
 * the asset through SkData; the file reads here are the test's own,
 * because the library takes no paths.
 */
