...
// RGBA_F32 SkImages so HDR range survives into compositing. The Skia
// SVG module, when built in (SIGILIMAGE_HAS_SVG), rasterizes SVG
// sources at DecodeOptions::width/height (intrinsic size by default).
//
