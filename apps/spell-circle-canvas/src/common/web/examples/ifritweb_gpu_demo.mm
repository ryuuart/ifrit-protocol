// GPU IfritWeb demo — the all-hardware pipeline: Ultralight renders an
...
<body><div class="board">
  ...
  <div class="card wide"><div>
    ...
    <p>Ultralight executed its fill and path shaders through IfritWeb's
...
int main(int argc, char **argv) {
  std::filesystem::path outDir = argc > 1 ? argv[1] : "ifritweb_demo_out";
