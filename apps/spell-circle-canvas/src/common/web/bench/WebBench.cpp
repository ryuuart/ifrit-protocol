// Benchmarks for the IfritWeb integration paths — what each compositing
...
//
//   web_bench          # CPU engine (raster SkImage frames)
//   web_bench --gpu    # GPU engine (Metal driver, texture frames)
//
