// SigilMotionClock: the frame clock's pause/scale/clamp behavior and the
// Ticker driving Choreograph motions, steppables and derivations to
// completion with no renderer under it.
