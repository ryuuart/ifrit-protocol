...
EnvironmentMap EnvironmentMap::studio(int width) {
  return fromEquirect(bakeEquirect(width, [](float u, float v) -> SkV3 {
...
EnvironmentMap EnvironmentMap::sunset(int width) {
  return fromEquirect(bakeEquirect(width, [](float u, float v) -> SkV3 {
