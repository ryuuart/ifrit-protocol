...
std::shared_ptr<const Recipe> make(const char* name, const char* body) {
  return std::make_shared<const Recipe>(
      Recipe::of<TextPaintParams>(name).body(Target::SkSL, body));
}

constexpr char kWater[] = R"(
...
constexpr char kMeshGradient[] = R"(
...
const std::shared_ptr<const Recipe>& waterRecipe() {
  static const auto recipe = make("kit.water", kWater);
  return recipe;
}
...
const std::shared_ptr<const Recipe>& meshGradientRecipe() {
  static const auto recipe = make("kit.meshGradient", kMeshGradient);
  return recipe;
}
...
const std::shared_ptr<const Recipe>& sparkleRecipe() {
  static const auto recipe = make("kit.sparkle", kSparkle);
  return recipe;
}
...
const std::shared_ptr<const Recipe>& starNestRecipe() {
  static const auto recipe = make("kit.starNest", kStarNest);
  return recipe;
}
...
const std::shared_ptr<const Recipe>& cloudsRecipe() {
  static const auto recipe = make("kit.clouds", kClouds);
  return recipe;
}
...
const std::shared_ptr<const Recipe>& tunnelRecipe() {
  static const auto recipe = make("kit.tunnel", kTunnel);
  return recipe;
}
