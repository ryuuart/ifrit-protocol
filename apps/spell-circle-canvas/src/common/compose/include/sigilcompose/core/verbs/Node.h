 ...
 *  shape, its mask, the cascade it declares, its paint, its decorations,
 *  the compositing lanes, the two transform stacks, and what it is in
 *  the tree. A verb family NOT here belongs to one kind of leaf, and
 *  calling it on a node that cannot use it does not compile. */
