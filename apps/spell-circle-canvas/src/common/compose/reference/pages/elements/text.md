...
common_verbs: [font, ink, block, maxLines, ellipsis, textFill, textStroke, paragraphs]
---
...
def text(value: str, size: FloatLike | None = None,
         color: ColorLike | None = None) -> Element: ...
def text(value: str, style: weave.TextStyle) -> Element: ...
def text(content: weave.RichText) -> Element: ...
```
