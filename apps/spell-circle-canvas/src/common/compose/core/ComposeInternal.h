 ...
 * with the few runtime declarations that go with the text description it
 * holds. What that payload is COMPARED through is ComposeCompare.h,
 * included here so a translation unit that spells one has both.
 */
