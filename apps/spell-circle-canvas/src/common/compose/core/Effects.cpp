/** @file
 * The paint values with bodies: a shader Fill, and the Effect — filters,
 * shaders with children and uniforms, blurs, chaining, and what an effect
 * declares about its own motion and its need for world space.
 */
