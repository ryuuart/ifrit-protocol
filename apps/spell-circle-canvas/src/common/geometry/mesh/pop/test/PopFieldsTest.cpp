...
TEST(Pop, FieldsAreAddressableByName) {
  ...
  pop::Operation twist = pop::Deform{};
  ...
  pop::Operation group = pop::Select{};
  ...
  pop::Operation scatter = pop::SplineScatter{};
  ...
  pop::Operation promote = pop::Promote{};
  EXPECT_FALSE(pop::setField(promote, "to", 1.0f));
  pop::Operation given = pop::PointSet{};
