/** @file
 * The PLY writer: a cloud's positions and every lane, or a mesh's
 * vertices and triangles, as ascii rows or raw little-endian bytes
 * under one header grammar the reader folds back.
 */
