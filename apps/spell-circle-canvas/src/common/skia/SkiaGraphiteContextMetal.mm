...
std::unique_ptr<SkiaGraphiteContext> SkiaGraphiteContext::createMetal(void *mtlDevice,
  ...
  std::unique_ptr<skgpu::graphite::Context> context = skgpu::graphite::ContextFactory::MakeMetal(
