#include "textflowkit/SampleText.h"

#include "textflowkit/Labels.h"
...
textflow::Paragraph mixedScriptFiller(int wordCount, float fontSize,
  ...
  const textflow::TextStyle styles[3] = {makeStyle(fontSize, chunkColors[0]),
