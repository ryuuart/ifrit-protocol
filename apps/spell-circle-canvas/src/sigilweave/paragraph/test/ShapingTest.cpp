/** @file
 * Shaping through the paragraph: the shape cache and what an edit or a
 * restyle sends back through it, itemization (script and word
 * segmentation, fallback resolution, bidi), complex-script correctness
 * (Arabic, Devanagari, SMP, emoji clusters), the cache purge, and
