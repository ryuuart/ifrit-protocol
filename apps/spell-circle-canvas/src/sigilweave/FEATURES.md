...
- [Conventions and gotchas](CONVENTIONS.md) — its own chapter: read it before writing against the library
...
SigilCompose is the worked example. `Text::textWillChange` is the
