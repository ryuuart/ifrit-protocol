// weave_shaping_bench — the shaper per word: a word through HarfBuzz
// against the same word served from the shape cache, and a whole
// paragraph shaped cold against warm, which is what the cache absorbs.
