...
[[nodiscard]] std::vector<CharRange> findAllOccurrences(
    const Paragraph& paragraph, std::u16string_view needle);
...
[[nodiscard]] std::vector<CharRange> findAllOccurrences(
    const Paragraph& paragraph, std::u8string_view utf8Needle, CharRange scope);
...
class MarkerSet {
 public:
  ...
  [[nodiscard]] const std::vector<CharRange>* rangesFor(
