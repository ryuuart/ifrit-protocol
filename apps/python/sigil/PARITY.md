...
| `tile map` | Memoized chunks over one shared image asset with regions; bound flash opacity; profiling probe composer; readouts | `sketch::kit::sectionHeader`; `sketch::kit::readout`; `compose::image` over a shared `image::ImageAsset` |
